      ...
      <div class="formTitle fixed-form pt-1">
        ...
        <div v-if="currentTab == 'tab3'" class="paperLookTab tab3">
          <div class="form-group pt-3 mx-4">
            ...
            <span
              class="float-right bg-dark font-md text-light display-length px-1"
                ...
                >
                  ...
                  >
                    <div class="row" style="width: 97%">
                      ...
                      >
                        <span class="font-md dueDate">Due Date:</span>
                      </div>
                      <div
                        v-if="isSheetsView || isKanbanView"
                        class="col-3 pl-0"
            ...
            <p v-else class="text-danger font-md">No checks..</p>
          </div>
            ...
            >
              ...
              >
                <span class="d-inline-block w-100"
                  ...
                  <span class="font-md text-muted">{{ noteBy(note) }}</span>
                  <span
                    v-if="allowDeleteNote(note)"
                    class="clickable font-md delete-action float-right"
