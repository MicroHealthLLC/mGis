...
<script>
  ...
  import DetailShow from '../../components/facilities/detail_show'
  import NotesIndex from '../../components/notes/notes_index'
  import IssueIndex from '../../components/issues/issue_index'
  import RiskIndex from '../../components/risks/risk_index'
