...
<script>
  ...
  import NotesSheetsIndex from '../../components/notes/notes_sheets_index'
  import IssueSheetsIndex from '../../components/issues/issue_sheets_index'
  import TaskSheetsIndex from '../../components/tasks/task_sheets_index'
